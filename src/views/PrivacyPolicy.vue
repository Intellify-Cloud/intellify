<template>
  <div class="mt-32 section">
    <div class="w-full md:w-2/3 mx-auto">
      ...
      <h2 class="text-2xl font-semibold mt-8 mb-4">Personal Information We Collect</h2>
      <p class="mb-6">
        We do not collect any data about you or use any cookies.
      </p>

      <h2 class="text-2xl font-semibold mt-8 mb-4">Changes</h2>
      <p class="mb-6">
      ...
      <p>
        ...
        <a href="mailto:support@intellify.co.za"
          class="text-accent underline hover:text-highlight">support@intellify.co.za</a>.
      </p>
    </div>
  </div>
</template>
